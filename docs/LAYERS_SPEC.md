...
- [ ] `retrieve`: tokenize query + FTS + **top‑k** + **MMR-lite** on text similarity (cheap) or naive diversity by type.
- [ ] Emit **`contextBlock`** matching Ralph-friendly delimiters.
- [ ] Golden tests with fixture DB.
